...
```
$ docker image tag invoice lnparasuram/invoice
$ docker push lnparasuram/invoice
$ docker image tag notification lnparasuram/notification
$ docker push lnparasuram/notification
$ docker image tag store lnparasuram/store
$ docker push lnparasuram/store
```
