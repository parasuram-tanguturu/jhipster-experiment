...
describe('Customer e2e test', () => {
  ...
  /*  it('should create and save Customers', async () => {
        ...
        await promise.all([
            ...
            customerUpdatePage.setEmailInput(';)l_nK+Hy_xr\b?bq&amp;trC$1]P`y30}R`Um{_l&#39;~pb!Z6m7%|x/q&#34;fMjsk(!Zq*Kd#_@D.!~zmoio&gt;&gt;Q{~U,I5lJ#_Sn?)iW#1.W+~hVN]B{8Umkf25FAe^i%lz(uP&#34;x*'),
        ...
        expect(await customerUpdatePage.getEmailInput()).to.eq(';)l_nK+Hy_xr\b?bq&amp;trC$1]P`y30}R`Um{_l&#39;~pb!Z6m7%|x/q&#34;fMjsk(!Zq*Kd#_@D.!~zmoio&gt;&gt;Q{~U,I5lJ#_Sn?)iW#1.W+~hVN]B{8Umkf25FAe^i%lz(uP&#34;x*', 'Expected Email value to be equals to ;)l_nK+Hy_xr\b?bq&amp;trC$1]P`y30}R`Um{_l&#39;~pb!Z6m7%|x/q&#34;fMjsk(!Zq*Kd#_@D.!~zmoio&gt;&gt;Q{~U,I5lJ#_Sn?)iW#1.W+~hVN]B{8Umkf25FAe^i%lz(uP&#34;x*');
